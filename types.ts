...
export interface Message {
  ...
  /** RP fork: deliver this message as a real user message (sendUserMessage)
   *  instead of an intercom notification. Used by send_message and duplex
   *  forwarding. */
  deliverAsUser?: boolean;
  /** RP fork: write to the background JSON queue instead of triggering a turn. */
  background?: boolean;
